...
import { RiCheckboxCircleLine, RiArrowDownSLine } from "react-icons/ri";
...
export default function Time ({handleTime}) {
    ...
    return (<>
        ...
        <div id={style.time_container}>
            <div>
                {/* <RiCheckboxCircleLine className={style.icon}/> */}
                <BsFillPatchCheckFill className={style.icon}/>
                {/* <BsCalendarCheckFill className={style.icon}/> */}
                {/* Si da el tiempo, hacer que en lugar de inmueble se muestre la categoría del producto de forma dinámica */}
